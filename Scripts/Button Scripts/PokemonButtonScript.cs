    ...
    public void ButtonPress()
    {
        switch (sceneName)
        {
            ...
            case "New Hunt Menu":
                ...
                newHuntPageScript.newHuntPopupWindow.UpdateRegularFilename(Application.dataPath + "/Art Assets/Pokemon/Sprites/Caught/Normal/" + pokemonName + ".png");
                newHuntPageScript.newHuntPopupWindow.UpdateShinyFilename(Application.dataPath + "/Art Assets/Pokemon/Sprites/Caught/Shiny/" + pokemonName + ".png");
